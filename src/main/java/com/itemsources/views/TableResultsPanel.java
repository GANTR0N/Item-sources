...
import com.itemsources.osrswiki.DropTableSection;
...
public class TableResultsPanel extends JPanel {
    ...
    public TableResultsPanel(ItemSourcesConfig config, DropTableSection[] dropTableSections, ViewOption viewOption, JButton collapseButton, JButton percentButton, int selectedTabIndex) {
        this.config = config;
