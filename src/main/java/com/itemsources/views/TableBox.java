...
import com.itemsources.ItemSourcesConfig;
import com.itemsources.osrswiki.WikiItem;
import com.itemsources.utils.Util;
...
import static com.itemsources.utils.Icons.COLLAPSE_ICON;
import static com.itemsources.utils.Icons.EXPAND_ICON;

public class TableBox extends JPanel {
    private ItemSourcesConfig config;
    ...
    public TableBox(ItemSourcesConfig config, WikiItem[] items, ViewOption viewOption, String headerStr, JButton percentButton) {
        this.config = config;
        this.items = items;
