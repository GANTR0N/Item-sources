...
import com.itemsources.utils.Icons;
import com.itemsources.views.ItemSourcesPanel;
...
public class ItemSourcesPlugin extends Plugin {
    ...
    protected void startUp() {
        panel = new ItemSourcesPanel(config);
    ...
    @Provides
    ItemSourcesConfig provideConfig(ConfigManager configManager) {
        return configManager.getConfig(ItemSourcesConfig.class);
    }
